...
function user_permission_ui_update($main_screen_id = "",$user_type="",$department_name="",$screen_unique_id_count="", $action_unique_id_count="",$action_unique_ids="") {
              ...
              foreach ($user_actions as $action_value) {
                  ...
                  if (in_array($action_unique_id,$screen_actions)) {
                      ...
                      foreach($screen_unique_id_count as $demo){
                          ...
                          //  $a     = explode(",",$demo);
                            dd($demo);
                          // while($screen_unique_id_counts) {
                          //     // echo $screen_unique_id_counts;
                              
                          //     dd($screen_unique_id_counts);
                          //   }
                     
                          // $j = $screen_unique_id_counts[$screen_unique_id];
                          // for ($i = 0; $i < $j; $i++) {
                          //     print $screen_unique_id_counts;
                          //   }

                          foreach ($screen_unique_id_counts as $item) {
                          }
                          if($screen_unique_id_counts == $screen_unique_id){
