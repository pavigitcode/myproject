...
class offenceWiseReportController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $offence_vehicle = DB::table('view_nature_of_offence')
    ...
    //    dd($offence_vehicle);
       ...
       return view('reports.nature_of_offence',compact('offence_vehicle'))->with('i', (request()->input('page', 1) - 1) * 10);
    //    return $offence_veh;
