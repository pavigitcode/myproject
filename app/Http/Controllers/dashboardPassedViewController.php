...
class dashboardPassedViewController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($user_type_name == '62c80e7c2536911885' || $user_type_name == '62c80e8cac02318910' || $user_type_name == '63b4fd095bf7675259'  ||$user_type_name == '646329c163c3d77002') {
            ...
            ->where(['offence_vechicle_booking.is_delete' => 0, 'offence_vechicle_booking.need_offence_booking_sts' => 0])
            ...
            ->where(['offence_vechicle_booking.intelligence_division' => $division_name, 'offence_vechicle_booking.is_delete' => 0,'offence_vechicle_booking.need_offence_booking_sts' => 0])
