...
// =====================================mythili=====================================================
  ...
  // Main Screen Function
function user_main_screen($unique_id = "") {


    $user_main_screen_value = DB::table('user_screen_main')->select("unique_id", "screen_main_name","icon_name")->where(["is_active" => 1,"is_delete" => 0])->orderBy('id', 'ASC')->get();
    // $main_screens = $pdo->select($table_details, $where,'','',$order_by);
...
function user_screen_names($section_unique_id)
{
    ...
    $screen_sections = DB::table('user_screen')->select("unique_id", "user_screen_name", "folder_name", "icon_name", "main_screen_unique_id", "actions")->where("main_screen_unique_id", '=', $section_unique_id)->where("is_delete", '=', 0)->orderBy('id', 'ASC')->get();
...
function menu_permission ($user_type_id = "") {
    ...
    if ($user_type_id) {
        ...
        $screen_sections = DB::table('user_screen_permission')->where("user_type", '=', $user_type_id)->select(DB::raw('group_concat(screen_unique_id) AS screen_unique_id'))->orderBy('id', 'ASC')->get();
...
function menu_permission_main ($user_type_id = "") {
    ...
    if ($user_type_id) {
        ...
        $main_screen_unique_id = DB::table('user_screen_permission')->where("user_type", '=', $user_type_id)->select(DB::raw('group_concat(main_screen_unique_id) as main_screen_unique_id'))->orderBy('id', 'ASC')->get();
        // dd("hii".$main_screen_unique_id);
