    ...
    <div class="main-content">
       <div class="row">
        ...
        <div class="card text-left">
            <div class="card-body">
    <form class="was-validated" method="post" action="{{ route('rovingsquad_creation.store') }}" autocomplete="off">
        @csrf
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select class="form-control" name="roving_division_name" id="roving_division_name">
                    ...
                    <option value="{{ $roving_division_name->unique_id }}">
                        {{ $roving_division_name->division_name }}
                    </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-sm-4">
                <input class="form-control" id="area_name" name="area_name" type="text" placeholder="" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="roving_squad_number" name="roving_squad_number"
