...
<div class="main-content-wrap d-flex flex-column" style="margin-top: 60px;">
    <div class="main-content">
        ...
        <div class="card text-left">
            <div class="card-body">
                <form class="was-validated" method="post" action="{{ route('usertype.update',$usertype->id) }}" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="user_type" name="user_type" class="form-control" value="{{ $usertype->user_type }}" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <select name="is_active" id="is_active" class="select2 form-control" required>
                                        ...
                                        <option value='0' {{ $usertype->is_active == '0' ? 'selected' : '' }}>In Active</option>
                                    </select>
                                </div>
                            </div>
                            <!--  <div class="form-group row ">
                            ...
                            <div class="form-group row ">
                                <div class="col-md-12" align="right">
                                    ...
                                    <a href="{{ route('usertype.index') }}"><button type="button" class="btn btn-danger waves-effect waves-light">Cancel</button></a>
