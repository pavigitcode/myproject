                            ...
                            <div class="ul-widget1">
                                <div class="ul-widget4__item ul-widget4__users">
                                    ...
                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Vehicle Intercepted
                                        ...
                                        <span class="ul-widget2__username" href="#"><a href="#"><span id="check" class="ul-widget4__number t-font-boldest text-primary change-co"></span></a></span>
                                    </div>
                                    


                                    <!-- <img class="img1" id="get_view_data" src="{{ asset('public/asset/images/eye.png')}}"> -->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title w-100 text-center text-info"><b>Checked - <span id="checked_count"></span> </b></h4>
                                                ...
                                                <button onclick="printData()" class="print" id="print">Print</button>
                                                    <table class="display table table-striped table-bordered" id="table1"  style="width:100%">
                                                        <thead>
                                                            <tr>
                                                            <th>S.No</th>
                                                                <th>Entry Date</th>
  ...
  <label for="vehicle1"></label><br>
                                ...
                                <div class="ul-widget4__item ul-widget4__users">
                                    ...
                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Vehicle Passed</a>
                                        <span class="ul-widget2__username" href="#"><a href="#"><span class="ul-widget4__number t-font-boldest text-success change-co" id="passed_check"></span></a></span>
                                    </div>
                                    <!-- <img class="img1" id="get_view_passed_data" src="{{ asset('public/asset/images/eye.png')}}"> -->
                                  ...
                                  <div class="modal" id="myModal1">
                                      <div class="modal-dialog modal-lg">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  <h4 class="modal-title w-100 text-center text-info"><b>Passed - <span id="passed_count1"></span> </b></h4>
                                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="get_close()">×</button>
                                              </div>
                                              <div class="container"></div>
                                              <div class="modal-body">
                                              <button onclick="printData2()" class="print" id="print">Print</button>
                                                  <table class="display table table-striped table-bordered" id="table2" style="width:100%">
                                                      <thead>
                                                          ...
                                                          <th>S.No</th>
                                                              ...
                                                              <th>Vehicle No.</th>
                                                              <th>Offence Remarks</th>
                                                          </tr>
                                                      </thead>
                                                      <tbody id="get_passed_popup">
                                ...
                                <div class="ul-widget4__item ul-widget4__users">
                                    ...
                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Offence Booked</a>
                                        <span class="ul-widget2__username" href="#"><a href="#"><span class="ul-widget4__number t-font-boldest text-danger change-co" id="vech_check"></span></a></span>
                                    </div>
                                    <!-- <img class="img1" id="get_view_offence_data" src="{{ asset('public/asset/images/eye.png')}}"> -->
                                    


                                    <div class="modal" id="myModal_off">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title w-100 text-center text-info"><b>Offence Booked - <span id="offence_count1"></span> </b></h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="get_close()">×</button>
                                                </div>
                                                <div class="container"></div>
                                                <div class="modal-body">
                                                <button onclick="printData3()" class="print" id="print">Print</button>
                                                    <table class="display table table-striped table-bordered" id="table3" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                            <th>S.No</th>
                                                                <th>Entry Date</th>
                                                                ...
                                                                <th>Vehicle No.</th>
                                                                <th>Offence Remark</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="get_offence_popup">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card text-center border-primary">
                    ...
                    <div class="card-body" id="demo1" style="overflow-y: scroll !important; height: 337px;">
                        <!-- -->
                        <!-- -->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card text-center border-primary">
                    ...
                    <div class="card-body" id="demo" style="overflow-y: scroll !important; height: 337px;">
...
<script>
                    ...
                    if (data.demos == '') {
                        ...
                        $.each(data.over_amount, function(i, item2) {
                            ...
                            $.each(data.demos, function(i, item) {
                                ...
                                $('#demo1').append('<div class="ul-widget5"><div class="ul-widget-s5__item mb-1"><div class="ul-widget-s5__content" style="display:grid !important;"><div class="ul-widget-s5__section"><div class="reve-img"><img id="userDropdown" src="../public/asset/images/location.png" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></div><a class="ul-widget4__title" href="#">' + item.division_name + '</a></div></div><div class="ul-widget-s5__content"><div class="ul-widget-s5__progress"><div class="ul-widget-s5__stats" style="display: unset;"><div class="row revenue"><div class="col-md-8 cc1"><h3 class="text-primary">Offence Count / Value</h3><p class="text-primary">' + count + ' <small>Count</small> /  <span class="text-success"> ' + tax_amount + ' <small>Value</small></span></p></div> <!-- <div class="col-md-4 cc2"><h3 class="text-success" >Offence value</h3><p class="text-success">10000</p></div>--><!--  <div class="col-md-4 cc3"><h3 class="text-danger">Offence</h3><p class="text-danger">200</p></div>--></div></div><div class="progress"><div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" style="width: ' + percentage + '%;">' + percentage + '</div></div></div> </div></div>');
                                // <a  href="" class="eye-icom2"><img src="../asset/images/eye.png"></a>
    ...
    $("#check").click(function() {
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('checked_vehicle_data.index') }}',
            data: {
                'month': month,
                'division_name': division_name,
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    var div = '';
                    $('#checked_count').append(data.count);
                    if (data.checked_vehicle == '') {

                        $('#get_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td colspan="6"><h1 style="text-align:center;color:red;">No Vehicle Data Found</h1></td> <td></td></tr>');
                        ...
                        $.each(data.checked_vehicle, function(i, item) {
                            ...
                            var j = i+1;
                                // if(item.veh_place == null){
                                //     veh_place = '-';
                                // }else{
                                //     veh_place = item.veh_place;
                                // }

    $('#get_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td>'+ j +'</td><td>'+item.booking_entry_date+'</td><td>'+item.poi_no+'</td> <td>'+item.division_name+'</td><td>'+item.vechicle_no+'</td>  </tr>');
    ...
    $("#passed_check").click(function() {
       
        
        $('#myModal1').show();
        $('#passed_count1').empty();
        $('#get_passed_popup').empty();
        var month = $("#month").val();
        var division_name = $("#division_name").val();
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('passed_vehicle_data.index') }}',
            data: {
                'month': month,
                'division_name': division_name,
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    var i = 0;
                    var div = '';
                    $('#passed_count1').append(data.count);
                    if (data.checked_vehicle == '') {

                        $('#get_passed_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td colspan="6"><h1 style="text-align:center;color:red;">No Vehicle Data Found</h1></td> <td></td></tr>');

                    } else {
                        $.each(data.checked_vehicle, function(i, item) {
                           
                            var k = i+1;
                            if(item.offence_remarks == null){
                                offence_remarks = '-';
                                }else{
                                    offence_remarks = item.offence_remarks;
                                }

    $('#get_passed_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td>'+k+'</td><td>'+item.duty_date+'</td><td>'+item.poi_no+'</td> <td>'+item.division_name+'</td><td>'+item.offense_booked_vehicle_number+'</td>  <td>'+offence_remarks+'</td></tr>');
    ...
    $("#vech_check").click(function() {
        
        
        
        $('#myModal_off').show();
        $('#offence_count1').empty();
        $('#get_offence_popup').empty();
        var month = $("#month").val();
        var division_name = $("#division_name").val();
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('offence_vehicle_data.index') }}',
            data: {
                'month': month,
                'division_name': division_name,
                'user_type_name': user_type_name,
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    var i = 0;
                    var div = '';
                    $('#offence_count1').append(data.count);
                    if (data.checked_vehicle == '') {

                        $('#get_offence_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td colspan="6"><h1 style="text-align:center;color:red;">No Vehicle Data Found</h1></td> <td></td></tr>');
    ...
    $('#get_offence_popup').append('<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle"><td>'+k+'</td><td>'+item.duty_date+'</td><td>'+item.poi_no+'</td> <td>'+item.division_name+'</td><td>'+item.offense_booked_vehicle_number+'</td>  <td>'+ offence_remarks+'</td></tr>');
...
// });
// // });
// var empDataTable2 = $('#table2').DataTable({
//     dom: 'Blfrtip',
//    buttons: [
//       {
//         extend: 'excel',
...
//    ]
// });
// var empDataTable3 = $('#tabledemo').DataTable({
// //    dom: 'Blfrtip',
// dom: 'Blfrtip',
//    buttons: [
//       {
...
html: '&shy;<style>' + css + '</style>'
    ...
    function printData3()
    {
       var divToPrint=document.getElementById("tabledemo");
       newWin= window.open("");
       newWin.document.write(divToPrint.outerHTML);
       var css =`table, td, th {
      border: 1px solid black;
