...
--> 
<!-- href="#myModal" -->
<!-- <a data-toggle="modal"  class="eye-icom">
    <img src="{{ asset('public/asset/images/eye.png')}}">
</a> -->
...
<a href="" class="eway-btn2"><i class="fa fa-check" aria-hidden="true"></i> Goods Match</a>
  ...
  <label for="vehicle1"></label><br>
                                ...
                                <div class="ul-widget4__item ul-widget4__users">
                                    ...
                                    <!-- <a href="" class="eye-icom"><img src="{{ asset('public/asset/images/eye.png')}}"></a> -->
                                </div>
                                <div class="ul-widget4__item ul-widget4__users">
...
$.ajax({
        ...
        success: function(data) {
            ...
            $('#demo').append('<div class="ul-widget5"><div class="ul-widget-s5__item mb-1"><div class="ul-widget-s5__content"><div class="ul-widget-s5__section"><div class="reve-img"><img id="userDropdown" src="../public/asset/images/location.png" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></div><a class="ul-widget4__title" href="#">'+ data.demos +'</a> </div> </div><div class="ul-widget-s5__content"> <div class="ul-widget-s5__progress"><div class="ul-widget-s5__stats" style="display: unset;"><div class="row revenue"><div class="col-md-4 col-4 cc1"><h3 class="text-primary">Intercepted</h3><p class="text-primary">'+data.checked_vehicle+' <small>Count</small></p></div> <div class="col-md-4 col-4 cc2"><h3 class="text-success" >Passed</h3><p class="text-success">'+data.passed+'<small>Count</small></p></div><div class="col-md-4 col-4 cc3"><h3 class="text-danger">Offence</h3><p class="text-danger">'+data.offenceVehicle+' <small>Count</small></p> </div></div></div> <div class="progress"> <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" style="width: 25%;">25</div> </div></div></div></div>');
            // <a  href="" class="eye-icom2"><img src="../public/asset/images/eye.png"></a>
        });
            }
     ...
     // division wise name and count end
...
// var k = i+1;
                    ...
                    $('#demo').append('<div class="ul-widget5"><div class="ul-widget-s5__item mb-1"><div class="ul-widget-s5__content"><div class="ul-widget-s5__section"><div class="reve-img"><img id="userDropdown" src="../public/asset/images/location.png" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></div><a class="ul-widget4__title" href="#">'+ val1[i].division_name +'</a> </div></div><div class="ul-widget-s5__content"> <div class="ul-widget-s5__progress"><div class="ul-widget-s5__stats" style="display: unset;"><div class="row revenue"><div class="col-md-4 col-4 cc1"><h3 class="text-primary">Intercepted</h3><p class="text-primary">'+val1[i].cnt_division+' <small>Count</small></p></div> <div class="col-md-4 col-4 cc2"><h3 class="text-success" >Passed</h3><p class="text-success">'+ val2[i].cnt_division +'<small>Count</small></p></div><div class="col-md-4 col-4 cc3"><h3 class="text-danger">Offence</h3><p class="text-danger">'+ val3[i].cnt_division +' <small>Count</small></p> </div></div></div> <div class="progress"> <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" style="width: 25%;">25</div> </div></div></div></div>');
