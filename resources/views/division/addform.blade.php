    ...
    <div class="main-content">
       <div class="row">
        ...
        <div class="card text-left">
            <div class="card-body">
               <form class="was-validated" method="post" action="{{ route('division_creation.store') }}" autocomplete="off">
                   @csrf
                  <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="">Division Name</label>
                      <div class="col-sm-4">
                         <input class="form-control" id="division_name" name="division_name" type="text" placeholder="" required>
                      </div>
                      <label class="col-sm-2 col-form-label" for="">Division Short Name</label>
                      <div class="col-sm-4">
                         <input class="form-control" id="division_short_name" name="division_short_name" type="text" placeholder="" required>
                      </div>
                    </div>
                    <div class="form-group row">
