                    ...
                    <tbody class="table_body" id="table_body">
                        <!-- $i=0; -->
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $checked_vehicle->vehno }}</td>
                                                <td>{{ $checked_vehicle->frplace }}</td>
                                                ...
                                                ?>
                                                <td><span class="badge badge-pill badge-danger" style="background:tomato">{{ $checked_vehicle->need_offence_booking_sts }}</span></td>
...
// alert(item.unique_id);
      ...
      tr += '<tr><td width="5%">' + k  + '</td><td width="15%">' + item.poi_no  + '</td><td width="15%">' + item.division_name  + '</td><td width="25%">' + item.vechicle_no + '</td><td width="20%">' + item.booking_entry_date + '</td><td width="15%">' + item.veh_place + '</td><td width="20%">' + item.veh_owner + '</td><td><span class="badge badge-pill badge-danger">' + item.need_offence_booking_sts + '</span></td><td><form action="'+destroyurl+'" method="POST"><a class="btn btn-info" href="'+updateurl+'"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>@csrf @method("DELETE")<a href="'+destroyurl+'"><button type="submit" class="btn btn-xs btn-danger btn-flat show_confirm" data-toggle="tooltip" title="Delete"><x-zondicon-trash style="height: 13px;" /></button></a></form></tr>';
