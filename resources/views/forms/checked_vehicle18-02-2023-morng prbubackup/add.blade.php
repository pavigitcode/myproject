                ...
                if (data && data.length > 0) {
                    ...
                    if (data.veh_data == '') {
                        ...
                        $('#data_show_table').show();
                            // console.log(data.eway_nos);

                                // $('#ewayno').append(data.eway_nos);
                                document.getElementById('ewayno').value=data.eway_nos;

                        // $.each(data.eway_nos, function(i, value) {
                            // alert(value);
                            // console.log(value);
                            // var arr = [];
                            // var arr = value.ewb_no;
                            // var eway_data_arr = value.ewb_no;
                            // // var a = array(eway_data_arr);
                            // console.log(eway_data_arr);
                        ...
                        var tr = '';
                        // item = data.Eway_data;
                        // <div class="col-md-4 form-group mb-2"><label for="firstName2">HSN code</label> <p>' + item.hsn_code + '</p> </div>
                        // <div class="col-md-4 form-group mb-2"><label for="firstName2">Reason for transportation</label><p>' + item.reason_for_trans + '</p></div>
                        // <td width="25%">' + item.ewb_dt + '</td>
                        // <div class="col-md-4 form-group mb-2"><label for="firstName2">Invoice number</label><p>' + item.ewb_part_a_itms_id + '</p></div>
