                            ...
                            <div class="row form-p">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <select class="form-control" id="offense_section" name="offense_section">
                                        {{-- <option value="{{ $offence_vehicle->nature_of_the_offense }}">$nature_offence_names</option>
                                        @foreach($nature_of_section as $offense_section)
                                        <option value="{{ $offense_section->offence_section }}" {{  $offense_section->offence_section == $offence_vehicle->offense_section ? 'selected' : '' }}>
                                            {{ $offense_section->offence_section }} offense_section_unique
                                        </option> --}}
