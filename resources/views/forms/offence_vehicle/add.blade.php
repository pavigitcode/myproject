...
<head>
    ...
    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/css/plugins/perfect-scrollbar.min.css" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/css/plugins/smart.wizard/smart_wizard.min.css" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/css/plugins/smart.wizard/smart_wizard_theme_arrows.min.css" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/css/plugins/smart.wizard/smart_wizard_theme_circles.min.css" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/css/plugins/smart.wizard/smart_wizard_theme_dots.min.css" /> -->
...
<div class="">
                                ...
                                <h3 class="border-bottom border-gray pb-2">
                                    ...
                                    <div class="row form-p">
                                        ...
                                        <div class="col-md-8 form-group mb-3">
                                            <h3 class="offence-no">OFFENCE NO :<span>{{ $poi_number }}</span></h3>
                                            <input type="hidden" name="poi_num" id="poi_num" value="{{ $poi_number }}" />
                                        </div>
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <select class="form-control" id="intelligence_division" name="intelligence_division">
                                                ...
                                                <option value="{{ $intelligence_division->unique_id }}">
                                        ...
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <select class="form-control" id="roving_squad_no" name="roving_squad_no">
                                                ...
                                                <option value="{{ $roving_squad_no->unique_id }}">
                                        ...
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <input type="date" id="duty_date" name="duty_date" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                                        </div>
                        ...
                        <div id="step-2">
                            ...
                            <div class="row form-p">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <!-- {{-- <p>TN09BE8123</p> --}} -->
                                    <input type="text" class="form-control" id="offense_booked_vehicle_number" name="offense_booked_vehicle_number">
                                </div>
                                <div class="col-md-4 form-group mb-3">
                                    <label for="firstName1"> Place of Interception</label>
                                    <input type="text" class="form-control" id="place_of_interception" name="place_of_interception">
                                </div>
                                <div class="col-md-4 form-group mb-3">
                                    <label for="firstName1">Offense Booking Time</label>
                                    <input type="time" class="form-control" id="offense_booking_time" name="offense_booking_time">
                                </div>
                                <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <select class="form-control" id="offense_section" name="offense_section">
                                        ...
                                        <option value="{{ $offense_section->unique_id }}">
    ...
    <!-- <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/plugins/jquery-3.3.1.min.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/plugins/bootstrap.bundle.min.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/plugins/perfect-scrollbar.min.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/scripts/script.min.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/scripts/sidebar-horizontal.script.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/plugins/jquery.smartWizard.min.js" />

    <link href="https://ascentrecyclers.in/chennai_admin_design/assets/dist-assets/js/scripts/smart.wizard.script.min.js" /> -->
                                     </div>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data && data.length > 0) {
                    ...
                    //   data=$.parseJSON( data ); //parse response string
                    $("#tax_type").val("");
                    $("#count_of_commodity_involved").val("");
                    $("#cgst_penalty").val("");
                    $("#sgst_penalty").val("");
                    $("#igst_penalty").val("");
                    $("#inter_amount").val("");
    ...
    $('#overallform').on('click', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route("offence_booking.store") }}',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            data: {
