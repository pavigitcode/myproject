                        ...
                        <div id="step-2">
                            ...
                            <div class="row form-p">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <!-- {{-- <p>TN09BE8123</p> --}} -->
                                    <input type="text" class="form-control" id="offense_register_number" name="offense_register_number" value="{{ $offence_vehicle->offense_register_number }}">
                                </div>
                                <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <select class="form-control" id="offense_section" name="offense_section" >
                                        ...
                                        <option value="{{ $offense_section->offence_section }}" {{  $offense_section->unique_id == $offence_vehicle->offense_section ? 'selected' : '' }}>
                        ...
                        <div id="step-3">
                            ...
                            <div class="row form-p">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="goods_value" name="goods_value">
                                </div>
                                <div class="col-md-4 form-group mb-3">
                ...
                success: function(data) {
                    if (data && data.length > 0) {
                        ...
                        $.each(data.officer_list, function(i, item) {
                            $('#nature_of_the_offense' ).append( '<option value="'+item.unique_id+'">'+item.offence_name+'</option>' );
