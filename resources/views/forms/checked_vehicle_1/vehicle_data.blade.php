                ...
                <div class="ul-widget1 vehcil-deta">
                    <div class="ul-widget__item">
                        <div class="ul-widget__info">
                            <h3 class="ul-widget1__title ceh-h1" id="vehicle_no">Vehicle No</h3>
                        </div>
                        <span class="ul-widget__number text-primary no-h3" ><b style="font-size: 21px;"></b></span>
                       
                    </div>
                    <div class="ul-widget__item">
                        <div class="ul-widget__info">
                            <h3 class="ul-widget1__title ceh-h1">Place</h3>
                        </div><span class="ul-widget__number text-danger no-h3">Chennai</span>
                    </div>

                    <div class="ul-widget__item">
                        <div class="ul-widget__info">
                            <h3 class="ul-widget1__title ceh-h1">Owner Name</h3>
                        </div><span class="ul-widget__number text-success no-h3">Mani</span>
                    </div>
                    <div class="ul-widget__item">
                        <div class="ul-widget__info">
                            <h3 class="ul-widget1__title ceh-h1">POI Number</h3>
                        </div><span class="ul-widget__number text-warning   no-h3"><b style="font-size: 21px;color: #000;">POICHN1221200001</b></span>
                    </div>
...
<div class="card-body">
    ...
    <div class="accordion chck-brd" id="accordionRightIcon">
        ...
        <div class="card">
            <div class="card-header header-elements-inline chek-no-pad">
                <h6 class="card-title ul-collapse__icon--size ul-collapse__right-icon mb-0">
                    <a class="text-default collapsed" data-toggle="collapse" href="#accordion-item-icon-right-2" aria-expanded="false">
                        <table class="table check-vechicle">
                            <tr>
                                <th width="5%">2</th>
                                <td width="15%">E-25485855</td>
            ...
            <div class="collapse" id="accordion-item-icon-right-2" data-parent="#accordionRightIcon" style="">
                <div class="card-body">
                    <div class="">
                        <div class="">
                            <div class="card-title">EWAY BILL PART A</div>
        ...
        <div class="card">
            <div class="card-header header-elements-inline chek-no-pad">
                <h6 class="card-title ul-collapse__icon--size ul-collapse__right-icon mb-0">
                    <a class="text-default collapsed" data-toggle="collapse" href="#accordion-item-icon-right-3" aria-expanded="false">
                        <table class="table check-vechicle">
                            <tr>
                                <th width="5%">3</th>
                                <td width="15%">E-25485855</td>
