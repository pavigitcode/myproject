              ...
              foreach ($user_actions as $action_value) {
                  ...
                  if (in_array($action_unique_id,$screen_actions)) {
                      ...
                      $total_ui   .= '<span class="toggle-button toggle-button--tuuli">
                                          ...
                                          <input onclick="check_me(\''.$screen_unique_id.'\',this)" class="all-checkbox '.$action_name.$section_unique_id.' all'.$section_unique_id.' screen'.$screen_unique_id.' allcheck-'.$screen_unique_id.'" data-main="'.$main_screen_id.'" data-section="'.$section_unique_id.'" data-screen="'.$screen_unique_id.'" data-action="'.$action_unique_id.'" id="'.$action_unique_id.'" '.$checked.' name="checkboxvalue[]" value="'.$action_unique_id.'" type="checkbox">
...
function user_permission_ui_update($main_screen_id = "",$user_type="",$department_name="") {
  ...
  if ($main_screen_id) {
      ...
      foreach ($screen_sections as $section_value) {
          ...
          foreach ($user_screens as $screen_value) {
              ...
              $total_ui       .= '<td>
                                      <span class="toggle-button toggle-button--tuuli">
                                          <input class = "all'.$section_unique_id.'" onclick="check_all(\'screen'.$screen_unique_id.'\',this)" name="checkall" id="checkall'.$screen_unique_id.'" value="'.$screen_unique_id.'" type="checkbox" '.$all_checked.' checked>
                                          <label for="all'.$screen_unique_id.'"></label>
                                          <div class="toggle-button__icon"></div>
                                      </span>
                                  </td>';
              ...
              foreach ($user_actions as $action_value) {
                  ...
                  if (in_array($action_unique_id,$screen_actions)) {
                      ...
                      $total_ui   .= '<span class="toggle-button toggle-button--tuuli">
                                          ...
                                          <input onclick="check_me(\''.$screen_unique_id.'\',this)" class="all-checkbox '.$action_name.$section_unique_id.' all'.$section_unique_id.' screen'.$screen_unique_id.' allcheck-'.$screen_unique_id.'" data-main="'.$main_screen_id.'" data-section="'.$section_unique_id.'" data-screen="'.$screen_unique_id.'" data-action="'.$action_unique_id.'" id="'.$action_unique_id.'" '.$checked.' name="checkboxvalue[]" value="'.$action_unique_id.'" type="checkbox" checked>
...
function get_permissions1($user_type = "",$main_screen = null,$screen_section = null,$screens=null,$screen_actions=null,$department_name = "") {
  ...
  if ($user_type) {
      ...
      // $permisiion_info = DB::table('user_screen_permission')->select('user_type','department_name','main_screen_unique_id','screen_unique_id', DB::raw('group_concat(action_unique_id) AS action_unique_id'))->where('is_delete',0)->groupBy('screen_unique_id')->get();
