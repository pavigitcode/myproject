...
<div class="row">
                ...
                <div class="col-md-12">
                    <div class="p-4">
                        <div class="auth-logo text-center mb-2"><img src=" {{ asset('asset/images/t-logo2.png')}}" alt=""></div>
                        ...
                        <form>
                            <div class="form-group mb-3">
                                ...
                                <!-- <input class="form-control" name="mobile_no" id="mobile_no" type="tel" required> -->
                            </div>
                            <!--<div class="form-group mb-3">
                            ...
                            <button class="btn btn-info" style="width:100%" data-toggle="modal" data-target="#exampleModal" type="button">Send OTP</button>
                        </form>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary ml-2" onclick="window.location='{{ route('dashboard.create') }}'">Login</button>
